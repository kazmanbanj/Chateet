<div class="flex">
    <form method="POST"
          action="/chats/<?php echo e($chat->id); ?>/like"
    >
        <?php echo csrf_field(); ?>

        <div class="items-center mr-4 <?php echo e($chat->isLikedBy(current_user()) ? 'text-blue-500' : 'text-gray-500'); ?>">
        <button type="submit"
                    class="flex text-xs"
            >
    ...
    >
        ...
        <div class="items-center <?php echo e($chat->isDislikedBy(current_user()) ? 'text-blue-500' : 'text-gray-500'); ?>">
        <button type="submit"
                    class="flex text-xs"
            >
            <svg viewBox="0 0 20 20"
            ...
            >
                ...
                <?php echo e($chat->dislikes ?: 0); ?>

            </button>
        </div>
    </form>
</div><?php /**PATH C:\Users\HP\Documents\FOFX\laravel\Chateet\resources\views\components\like-buttons.blade.php ENDPATH**/ ?>
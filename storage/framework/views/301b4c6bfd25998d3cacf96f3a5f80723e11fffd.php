<div class="border border-blue-400 rounded-lg px-8 py-6 mb-6">
    ...
    <?php echo csrf_field(); ?>
        ...
        <footer class="flex justify-between items-center">
            <img src="<?php echo e(auth()->user()->avatar); ?>" alt="" class="rounded-full mr-2" style="width:50px; height:50px; background-image: url('/images/test.jpg'); background-size:cover">

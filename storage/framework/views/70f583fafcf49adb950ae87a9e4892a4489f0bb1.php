...
<div class="container mx-auto flex justify-center">
    <div class="px-12 py-4 bg-gray-200 border-gray-400 rounded-lg">
        <div class="col-md-8">
                <div class="font-bold text-lg mb-2 text-center text-gray-700"><?php echo e(__('Confirm Password')); ?></div>
...
unset($__errorArgs, $__bag); ?>
                        ...
                        <div class="text-center">
                            <button type="submit" class="bg-blue-400 text-white rounded py-2 px-4 hover:bg-blue-500 mr-2"><?php echo e(__('Confirm Password')); ?>
...
<?php endif; ?>
<?php /**PATH C:\Users\HP\Documents\FOFX\laravel\Chateet\resources\views\auth\passwords\confirm.blade.php ENDPATH**/ ?>
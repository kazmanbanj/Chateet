...
<?php $component->withAttributes([]); ?>
    <header class="mb-6">
        <div class="">
            <img src="<?php echo e(asset('avatars/' . $user->id . '/' . $user->avatar)); ?>" class="rounded-lg border-none h-full mb-2 bg-gray-400 mr-auto ml-auto" style="height:300px; width: 300px;">
        </div>
...
<?php unset($__componentOriginalc254754b9d5db91d5165876f9d051922ca0066f4); ?>
<?php endif; ?>
<?php /**PATH C:\Users\HP\Documents\FOFX\laravel\Chateet\resources\views/profiles/show.blade.php ENDPATH**/ ?>
<x-app>
    <header class="mb-6">
        <div class="">
            <img src="{!! URL::asset('avatars/'. $user->id .'/'. str_replace('http://127.0.0.1:8000/', '', $user->avatar)) !!}" alt="{{ $user->username }}'s avatar" class="rounded-lg border-none h-full mb-2 bg-gray-400 mr-auto ml-auto" style="height:300px; width: 300px;">
        </div>

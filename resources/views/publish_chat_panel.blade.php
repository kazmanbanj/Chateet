<div class="border border-blue-400 rounded-lg px-8 py-6 mb-6">
    ...
    @csrf
        ...
        <footer class="flex justify-between items-center">
            <img src="{!! URL::asset('avatars/'. auth()->user()->id .'/'. str_replace('http://chateet.herokuapp.com/', '', auth()->user()->avatar)) !!}" class="rounded-full mr-2" style="width:50px; height:50px; background-image: url('/images/test.jpg'); background-size:cover">
